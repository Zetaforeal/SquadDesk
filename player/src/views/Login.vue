<template>
  <div class="login-page">
    <div class="login-card">
      <div class="brand">
        <div class="brand-icon"><Crosshair /></div>
        <h1>打手端</h1>
        <p>接单赚钱 · 随时随地</p>
      </div>
...
import { Crosshair, Building2, User, Lock } from 'lucide-vue-next';
...
async function submit() {
  ...
  try {
    ...
    localStorage.setItem('player_tenantId', form.tenantId);
...
.brand-icon {
  ...
  background: #2c5364; color: #fff; border-radius: 14px;
}
